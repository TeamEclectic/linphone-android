...
\multicolumn{1}{|R{2cm}|}{26/05/2015} & \multicolumn{1}{L{5.5cm}|}{Document Creation} & \multicolumn{1}{l|}{Team Eclectic} & \multicolumn{1}{L{4cm}|}{Version 1} \\ \hline
...
\multicolumn{1}{|l|}{} & \multicolumn{1}{L{4cm}|}{} & \multicolumn{1}{L{4cm}|}{} & \multicolumn{1}{L{4cm}|}{} \\ \hline
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} \\ \hline
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} \\ \hline
\multicolumn{1}{|l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} \\ \hline
\end{tabular}
...
\begin{figure}[H]
\centering
\includegraphics[width=380px]{./images/scope_master.png}
\caption[Project Scope]{This UML diagram shows the scope for the Linphone Group Chat extension.}
...
\paragraph{Summary:}The ManageGroups module provides services to create, update and remove or leave groups. The user can choose to create a group, specify its name, set a profile picture and add contacts.
\paragraph{Rationale:} The main aspect of the extention to the Linphone project is to provide group chat functionality. This use case gives the user the abilit to creat the actual group and initialize the use of the group. The user can set the group name, add a group photo and choose contacts to add to the group.   
\paragraph{Users:}  Any user of the Linphone application
\paragraph{Preconditions:}For each of the pre-conditions below an exception is introduced which is raised by the service to notify the caller that the service is not being provided as the pre-condition associated with that exception has not been met.\newline
...
\paragraph{Summary:} The create group use case should allow a user who has the Linphone service to create a group, name it, set detaials such as picture and add contacts to it.
...
\paragraph{Requirements:} When the user decided to create a group, the user must be afforded the option to do so. Once selected the user must be provided with the opportunity to give the group a name and picture. The system shpuld check the validty of the above activities and then allow the user to proceed if all options are valid. The user should then be afforded the opportunity to add contacts to the group. Once more than one contact is added the user is afforded to continue and finish creating the group.
